...
mkinitcpio -g /boot/initrd.img-6.19.9 -k 6.19.9
mkimage -A arm -O linux -T ramdisk -C none -a 0 -e 0 -n uInitrd -d /boot/initrd.img-6.19.9 /boot/uInitrd-6.19.9
rm -f /boot/dtb /boot/Image /boot/uInitrd
ln -sf dtb-6.19.9 /boot/dtb
ln -sf vmlinuz-6.19.9 /boot/Image
ln -sf uInitrd-6.19.9 /boot/uInitrd
...
cd linux
wget -O .config https://github.com/heiher/kernel-nanopi-m4/raw/master/boot/config-6.19.9
